...
function loadHtml5Gallery(p) {
    ...
    q.fn.touchSwipe = function(c) {
        ...
        return this.each(function() {
            ...
            function b(a) {
                if (0 < f || 0 < y) 100 < Math.abs(f - g) && (f > g ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()), 100 < Math.abs(y - j) && (y > j ? e.swipeBottom && e.swipeBottom.call() : e.swipeTop && e.swipeTop.call());
                c(a)
            }
    ...
    n.fn.drag = function(c, e, a) {
        var d = "string" == typeof c ? c : "",
            b = n.isFunction(c) ? c : n.isFunction(e) ? e : null;
    ...
    var r = n.event,
        ...
        l = u.drag = {
            ...
            interaction: function(c, e) {
                return {
                    drag: c,
                    callback: new l.callback,
                    droppable: [],
                    offset: n(c)[e.relative ? "position" : "offset"]() || {
                        top: 0,
                        left: 0
                    }
                }
            ...
            delegate: function(c) {
                var e = [],
                    a, d = n.data(this, "events") || {};
                n.each(d.live || [], function(b, d) {
                    if (0 === d.preType.indexOf("drag") && (a = n(c.target).closest(d.selector, c.currentTarget)[0])) r.add(a, d.origType + "." + l.livekey, d.origHandler, d.data), 0 > n.inArray(a, e) && e.push(a)
                });
            ...
            hijack: function(c, e, a, d, b) {
                if (a) {
                    ...
                    a.results = [];
                    do
                        if ((s = a.interactions[v]) && !("dragend" !== e && s.cancelled)) h = l.properties(c, a, s), s.results = [], n(b || s[j] || a.droppable).each(function(b, d) {
    ...
    h.fn.addHTML5VideoControls = function(c, e) {
        var a = "ontouchstart" in window,
            ...
            s = !1,
            l = !0,
            n = null != navigator.userAgent.match(/iPod/i) || null != navigator.userAgent.match(/iPhone/i),
            p = h(this).data("ishd"),
            r = h(this).data("hd"),
            q = h(this).data("src"),
            m = h(this);
        ...
        var G = h("<div class='html5boxVideoFullscreenBg'></div>"),
        ...
        h(".html5boxPlayPause", t).css({
            ...
            width: "32px",
            height: "32px",
            margin: Math.floor((j - 32) / 2),
            "float": "left"
        });
        var H = h(".html5boxPlay", t),
            I = h(".html5boxPause", t);
        H.css({
            display: "block",
            position: "absolute",
        ...
        var C = h(".html5boxTimeCurrent", t),
            L = h(".html5boxTimeTotal",
                t),
            w = h(".html5boxSeeker", t),
            E = h(".html5boxSeekerPlay", t),
            M = h(".html5boxSeekerBuffer", t),
            O = h(".html5boxSeekerHandler", t);
        C.css({
            display: "block",
            position: "relative",
            "float": "left",
        ...
        w.css({
            ...
            margin: Math.floor((j - 10) / 2) + "px 4px"
        }).bind(d, function(c) {
        ...
        if (!n && (m.get(0).requestFullscreen || m.get(0).webkitRequestFullScreen || m.get(0).mozRequestFullScreen || m.get(0).webkitEnterFullScreen || m.get(0).msRequestFullscreen)) {
            var J = function(a) {
                ...
                a ? (h(document).bind("mousemove", z), t.css({
                    "z-index": 2147483647
                })) : (h(document).unbind("mousemove", z), t.css({
                    "z-index": ""
                }))
            };
        ...
        r &&
            h(".html5boxHD", t).css({
                ...
                "background-position": (p ? "right" : "left") + " center"
            }).bind(g, function() {
                p = !p;
                h(this).css({
                    "background-position": (p ? "right" : "left") + " center"
        ...
        if (m.get(0).volume === u / 2 + 0.1) {
            ...
            var u = h(".html5boxVolume", t),
                ...
                K = h(".html5boxVolumeBar", t),
                x = h(".html5boxVolumeBarBg", t),
                B = h(".html5boxVolumeBarActive", t);
            u.css({
                display: "block",
                position: "relative",
                "float": "right",
            ...
            K.css({
                ...
                width: 24,
                height: 80,
                "margin-bottom": Math.floor((j - 32) / 2),
                "background-color": "#000000",
                opacity: 0.7,
                filter: "alpha(opacity=70)"
            });
    ...
    c.fn.html5gallery = function(h) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                a.options.fv ? a.options.watermarkcode = "<a style='text-decoration:none;display:none;' target='_blank' href='" + a.options.freelink + "' >" : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank' href='" + a.options.watermarklink + "' >");
                a.options.watermarkcode += "<div " + (a.options.fv ? "" : "class='html5gallery-watermark-" + a.id + "' ") + "style='" + (a.options.fv ? "display:block;position:absolute;top:10px;left:10px;width:170px;height:18px;line-height:18px;text-align:center;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;background-color:#fff;color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;" :
            ...
            readTags: function() {
                ...
                c("img", this.container).each(function() {
                    ...
                    var g = a.options.width,
                        j = a.options.height,
                        f = c(this).data("duration") ? c(this).data("duration") : 0,
                        v = null,
                        s = null,
                        h = null,
                        l = null,
            ...
            resizeStyleVertical: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (this.options.showcarousel)
                        ...
                        } else this.options.carouselWidth = this.options.thumbwidth, this.options.carouselHeight = this.options.height + this.options.headerHeight, this.options.carTop = 0, this.options.carBottom = 0, this.options.carAreaLength = this.options.carouselHeight - this.options.carTop - this.options.carBottom,
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        width: a + "px",
                        height: b + "px"
                    }), c("#html5gallery-elem-video-" + this.id).attr("width", a), c("#html5gallery-elem-video-" + this.id).attr("height", b), c(".html5gallery-elem-video-" + this.id).find("iframe").attr("width",
                    ...
                    this.options.showcarousel && (c(".html5gallery-car-" + this.id).css({
                        ...
                        this.options.carouselSlider && (this.options.carouselSliderMin = 0, this.options.carouselSliderMax = this.options.thumbMaskHeight - 54, c(".html5gallery-car-slider-bar-" + this.id).css({
            ...
            createStyleVertical: function() {
                ...
                var b = b + (" .html5gallery-box-" + this.id + " {display:block; position:absolute; text-align:center; left:" +
                    ...
                    b = b + (" .html5gallery-viral-" + this.id + " {display:block; overflow:hidden; position:absolute; text-align:left; top:" + d + "px; left:0px; width:" + this.options.boxWidth +
                    ...
                    b = b + (" .html5gallery-timer-" + this.id + " {display:block; position:absolute; top:" +
            ...
            resizeStyleDefault: function() {
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    }), this.options.carouselNavButton = !1, Math.floor((this.options.width - a - 4) / (this.options.thumbwidth + this.options.thumbgap)) < this.elemArray.length && (this.options.carouselNavButton = !0), d = this.options.carouselNavButton ? 2 * this.options.carouselarrowwidth + 8 : 0, c(".html5gallery-car-left-" + this.id).css({
                        display: this.options.carouselNavButton ? "block" : "none"
                    }), c(".html5gallery-car-right-" + this.id).css({
                        display: this.options.carouselNavButton ? "block" : "none"
                    }), this.options.thumbShowNum = Math.floor((this.options.width - a - 4 - d) / (this.options.thumbwidth +
                ...
                this.options.showcarousel && this.options.carouselmultirows ?
                    (b += " .html5gallery-car-" + this.id + " { position:absolute; display:block; overflow:hidden; left:" + this.options.carouselLeft + "px; top:" + this.options.carouselTop + "px; width:" + this.options.width + "px;", b = this.options.carouselbgtransparent ? b + "background-color:transparent;" : b + ("border-top:1px solid " + this.options.carouseltopborder + ";border-bottom:1px solid " + this.options.carouselbottomborder + ";background-color: " + this.options.carouselbgcolorend + "; background: " + this.options.carouselbgcolorend + " -webkit-gradient(linear, left top, left bottom, from(" +
                        ...
                        this.options.skinfolder + "carousel_left.png') no-repeat 0px 0px;}  .html5gallery-car-right-" + this.id + " { position:absolute; overflow:hidden; width:" + this.options.carouselarrowwidth + "px; height:" + this.options.carouselarrowheight + "px; right:0px; top:" + String(this.options.carouselHeight / 2 - this.options.carouselarrowheight / 2) + "px; background:url('" + this.options.skinfolder + "carousel_right.png') no-repeat 0px 0px;} ", d = this.options.carouselNavButton ? 2 * this.options.carouselarrowwidth + 8 : 0, c(".html5gallery-car-left-" +
                            ...
                            display: this.options.carouselNavButton ? "block" : "none"
                        }), this.options.thumbShowNum = Math.floor((this.options.width - a - 4 - d) / (this.options.thumbwidth + this.options.thumbgap)), this.options.thumbMaskWidth = this.options.thumbShowNum * this.options.thumbwidth + this.options.thumbShowNum * this.options.thumbgap, this.options.thumbTotalWidth = this.elemArray.length * this.options.thumbwidth + (this.elemArray.length -
                        ...
                        this.id + " {display:block; overflow:hidden; width:" + String(this.options.thumbimagewidth + 2 * this.options.thumbimageborder) + "px;height:" + String(this.options.thumbimageheight + 2 * this.options.thumbimageborder) + "px;}", this.options.thumbunselectedimagebordercolor && (b += " .html5gallery-tn-selected-" + this.id + " {background-color:" + this.options.thumbunselectedimagebordercolor + ";}"), this.options.thumbshowtitle ? (b += " .html5gallery-tn-title-" + this.id + " {display:block; overflow:hidden; float:top; height:" + this.options.thumbtitleheight +
                            ...
                            0 == a ? (b.css({
                                "background-position": "-" + String(2 * this.options.carouselarrowwidth) +
                                    "px 0px",
                                cursor: ""
                            }), b.data("disabled", !0)) : b.data("disabled") && (b.css({
                                "background-position": "0px 0px",
            ...
            goFullscreen: function() {
                ...
                var g = Math.max(e, c(document).height()),
                    j = Math.min(this.fullscreenWidth / d, this.fullscreenHeight / b);
                1 > j && (d *= j, b *= j);
                ...
                var h = c(".html5gallery-elem-" + this.id, this.$gallery).empty().css({
                    top: 0,
                    position: "relative"
                });
            ...
            slideRun: function(a, d, b, e) {
                ...
                if (this.options.showtitle ||
                    ...
                    } else this.options.showtitle && (g = "<div class='html5gallery-title-text-" + this.id + "'>" + g + "</div>", this.options.showdescription && a && (g += "<div class='html5gallery-description-text-" + this.id + "'>" + a + "</div>"), c(".html5gallery-title-" + this.id, this.$gallery).html(g))
                }
                a = this.elemArray[this.curElem][9];
                if (!(0 > a)) {
            ...
            showImage: function() {
                ...
                c(b).load(function() {
                    ...
                    b = Math.round(b * this.height);
                    var j = d.isFullscreen ? e : d.options.width,
                        f = d.isFullscreen ? b : d.options.height,
                        h = Math.round(j / 2 - e / 2),
            ...
            adjustFullscreen: function(a, d, b) {
                ...
                var j = Math.max(g, c(document).height()),
            ...
            showPoster: function() {
                ...
                c(j).load(function() {
                    ...
                    var n = Math.round(j / 2 - l / 2),
                        p = Math.round(h / 2 - f / 2);
                    ...
                    h = c(".html5gallery-elem-img-" +
                        b.id, d);
                    h.length ? (d.prepend(j), d.html5boxTransition(b.id, h, j, {
            ...
            showEmbedVideo: function(a) {
                ...
                if (g.match(/\:\/\/.*(dai\.ly)/i)) var j =
                    g.match(/(dai\.ly\/)([a-zA-Z0-9\-\_]+)/)[2],
                    g = (g.match(/https\:\/\//i) ? "https" : "http") + "://www.dailymotion.com/embed/video/" + j;
            ...
            showYoutube: function(a) {
                ...
                } else g = this.prepareYoutubeHref(g),
            ...
            showVimeo: function(a) {
                ...
                var j = this.elemArray[this.curElem][2],
                    ...
                    j = j + ("&api=1&player_id=html5gallery_vimeo_" + this.id);
            ...
            showIframe: function() {
                ...
                this.isFullscreen ? this.adjustFullscreen(d, b) : (c(".html5gallery-elem-" + this.id, this.$gallery).css({
                    width: this.options.width,
                    height: this.options.height
                }), d = this.options.width, b = this.options.height);
        ...
        this.each(function() {
            ...
            var k = {
                ...
                q = "vertical" == this.options.skin ? c.extend(q, n) : "showcase" == this.options.skin ? c.extend(q, r) : "light" == this.options.skin ? c.extend(q, k) : "gallery" == this.options.skin ? c.extend(q, j) : "gallerywithtext" == this.options.skin ? c.extend(q, f) : "horizontal" == this.options.skin ? c.extend(q, d) : "darkness" == this.options.skin ? c.extend(q, l) : "mediapage" ==
            ...
            for (d = 0; d < g.length; d++) k += String.fromCharCode(g[d]);
            this.options.fvm = k;
            ...
            if (this.options.screenquery)
                for (d in this.options.screenquery) k <= this.options.screenquery[d].screenwidth && (this.options.screenquery[d].gallerywidth && (this.options.width = this.options.screenquery[d].gallerywidth), this.options.screenquery[d].galleryheight &&
